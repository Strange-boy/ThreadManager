...
if (currentRoute === routes.browseThread) {
  ...
  browse.addEventListener("click", (e) => {
    ...
    onSnapshot(q, (snapshot) => {
      ...
      // var inlineCode = document.createTextNode('<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>');
      // tweetHtmlPage.appendChild(inlineCode);
      // document.body.appendChild(tweetHtmlPage);
